...
function RegLeftSideSecond(props) {
    ...
    return (
        <div style={gradientStyle}>
            ...
            <div style={{ marginTop: '20px', marginBottom: '30px', display: 'flex', flexDirection: 'column', justifyContent: 'space-around', width: '100%', textAlign: 'center' }}>
                ...
                <p style={{ fontSize: '20px', fontFamily: 'Josefin Sans', fontWeight: '300', color: '#FFFFFF' }}>Additional Information</p>
            </div>
...
export default RegLeftSideSecond;