          ...
          <div style={{ display: 'flex', flexDirection: 'row' }}>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <div className='same-line-input'>
                    <DetailItem>
                    <TextField id="filled-basic" label="Toy Name" variant="filled" defaultValue={user.name} InputProps={{
                      readOnly: true,
                    }} />
                  </DetailItem>
                  <DetailItem>
                    <TextField id="filled-basic" label="Toy Type" variant="filled" defaultValue={user.subtype} InputProps={{
                      readOnly: true,
                    }} />
                  </DetailItem>
