...
export default function FilterMedicalCases({ openFilter, onOpenFilter, onCloseFilter, set }) {

    const [speciality, setSpeciality] = useState('none');
    const [organizationName, setOrganizationName] = useState('none');
    const [governorate , setGovernorate] = useState('none');
    const [area , setArea] = useState('none');

    const apply = () => {
        set({
            speciality: speciality === 'none' ? null : speciality,
            organizationName: organizationName === 'none' ? null : organizationName,
