...
const SchoolSuppliesForm = () => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log('Submitted School Supplies Donation Form:', formData);
  };

  return (
    <form onSubmit={handleSubmit}>
      <h2>School Supplies Donation Post Details</h2>
      ...
      <TextField
        margin="normal"
        fullWidth
        label="School Supplies Needed"
        name="schoolSupplies"
        value={formData.schoolSupplies}
        onChange={handleChange}
        variant='filled'
      />
