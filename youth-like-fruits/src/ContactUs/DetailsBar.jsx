...
const DetailsBar = () => {
  return (
    <DetailsBarWrapper>
      ...
      <SocialsWrapper>
        <SocialIconWrapper href="https://www.facebook.com/ahmedyassertetoo/">
          <Icon.Facebook color="#fff" size={20} />
        </SocialIconWrapper>
        <SocialIconWrapper href="https://www.instagram.com/ahmed_y_tawfik/">
          <Icon.Instagram color="#fff" size={20} />
        </SocialIconWrapper>
        <SocialIconWrapper href="https://www.linkedin.com/in/ahmed-hussein-90172a267/">
